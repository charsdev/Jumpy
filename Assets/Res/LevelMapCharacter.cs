...
public class LevelMapCharacter : MonoBehaviour
{
	...
	public bool CollidingWithAPathElement; 
	...
	public WayPoint LastVisitedPathElement { get; set; }
	...
	public WayPoint _currentPathElement;
	...
	public virtual void SetCurrentPathElement(WayPoint pathElement)
	{
	...
	public virtual void SetDestination(WayPoint newDestination)
	{
